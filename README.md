...
1. 安装 [Fabric Loader](https://fabricmc.net/) >= 0.19.3
2. 安装 [Fabric API](https://modrinth.com/mod/fabric-api) >= 0.156.0
3. 从 [Releases](https://github.com/led-un/FlightMod-Fabric/releases) 下载 `flightmod-fabric-26.2.jar`，放入 `.minecraft/mods/` 目录
...
```bash
git clone https://github.com/led-un/FlightMod-Fabric.git -b 26.2
cd FlightMod-Fabric
./gradlew build
```
