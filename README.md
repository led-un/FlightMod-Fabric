...
3. 从 [Releases](https://github.com/led-un/FlightMod-Fabric/releases) 下载 `flightmod-fabric-26.1.1.jar`，放入 `.minecraft/mods/` 目录
...
```bash
git clone https://github.com/led-un/FlightMod-Fabric.git -b 26.1.1
cd FlightMod-Fabric
./gradlew build
```
