# FlightMod (Fabric 1.21.3) - 轻量级飞行+防摔模组

Minecraft Fabric 1.21.3 辅助模组，提供飞行和防摔功能。

> 其他 MC 版本分支： [1.20.1](https://github.com/led-un/FlightMod-Fabric/tree/1.20.1) | [1.21](https://github.com/led-un/FlightMod-Fabric/tree/1.21) | [1.21.1](https://github.com/led-un/FlightMod-Fabric/tree/1.21.1) | [1.21.2](https://github.com/led-un/FlightMod-Fabric/tree/1.21.2) | [1.21.4](https://github.com/led-un/FlightMod-Fabric/tree/1.21.4) | [1.21.5](https://github.com/led-un/FlightMod-Fabric/tree/1.21.5) | [1.21.8](https://github.com/led-un/FlightMod-Fabric/tree/1.21.8) | [1.21.10](https://github.com/led-un/FlightMod-Fabric/tree/1.21.10) | [1.21.11](https://github.com/led-un/FlightMod-Fabric/tree/1.21.11)
...
2. 安装 [Fabric API](https://modrinth.com/mod/fabric-api) >= 0.114.1
3. 从 [Releases](https://github.com/led-un/FlightMod-Fabric/releases) 下载 `flightmod-fabric-1.21.3.jar`，放入 `.minecraft/mods/` 目录
...
```bash
git clone https://github.com/led-un/FlightMod-Fabric.git -b 1.21.3
cd FlightMod-Fabric
./gradlew build
```
